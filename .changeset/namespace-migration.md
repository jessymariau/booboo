---
"@booboo-brain/cli": patch
"@booboo-brain/build": patch
"@booboo-brain/serve": patch
"@booboo-brain/spec": patch
"@booboo-brain/vault": patch
"@booboo-brain/viewer": patch
"@booboo-brain/panel": patch
"create-booboo": patch
---

Point `mcpName` and every package's repo metadata at the current GitHub identity
(`jessymariau`).
...
the *current* GitHub login, so the published entries under
