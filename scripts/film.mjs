...
const enc = (out, extra) => {
  const r = spawnSync(FFMPEG, [
    ...
    "-vf", "format=yuv420p", ...extra, "-an", resolve(out),
...
spawnSync(FFMPEG, ["-y", "-i", join(frames, String(Math.round(SECS * FPS)).padStart(5, "0") + ".png"), "-q:v", "3", resolve(base + ".jpg")], { stdio: "ignore" });
